...
export const VehicleUpdateUIView = ({ control, handleFormSubmit, brandsOptions, modelsOptions, colorsOptions, closeModal }: IVehicleUpdateUI) => {
  return (
    <div className="flex h-full w-full max-w-full min-h-0 flex-col gap-2 overflow-x-hidden md:w-[40vw]">
      ...
      <CustomFooterModal onConfirm={handleFormSubmit} onCancel={closeModal} />
    </div>
  );
};